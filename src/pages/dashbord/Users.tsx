import { Button, Flex, Form, Modal, Pagination, PaginationProps, Popconfirm, Select, Table, TableColumnsType, TableProps, Typography, message } from 'antd';
import React, { useEffect, useState } from 'react'
import userSource from "../../json/tabelUser.json"
import { DeleteOutlined, EditOutlined, UserAddOutlined } from '@ant-design/icons';
import Input from 'antd/es/input/Input';
import axiosPrivate from '../../libs/axios/index';
import ModalEditUser from '../../components/cards/EditUser';
import { useDispatch, useSelector } from 'react-redux';
import { AppDispatch, RootState } from '../../libs/redux/store';
import { IUser } from '../../types/schema';
import { userRole } from '../../utils';
import { useSearchParams } from 'react-router-dom';
import { fetchRoom, fetchUsers } from '../../services/redux';
...
function Users() {
    ...
    return (
        <div>
            ...
            >
                <ModalEditUser key={new Date().getTime()} open={isEditUser} onClose={handlerEditUser} user={isEditUser.user} />
                <Table
