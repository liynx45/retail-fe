...
import { status_room } from '../../utils/code._status'
...
const AddRoom: React.FC = () => {
  ...
  const createHandler = async () => {
    ...
    Object.keys(reqData).forEach((data: string) => {
      formData.append(data, reqData[data])
    })
                    ...
                    options={[
                      {
                        ...
                        label: "Pemeliharaan",
                        value: status_room.MAINTANCE
                      },
                      {
                        label: "Pending",
                        value: status_room.PENDING
                      }, {
                        label: "Disewakan",
                        value: status_room.RENT
                      }
                    ]} />
                </Form.Item>
                <Form.Item
